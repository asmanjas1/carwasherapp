...
public class CarwasherOrdersCompletedAdapter extends RecyclerView.Adapter<CarwasherOrdersCompletedAdapter.OrderViewHolder>{
    ...
    public CarwasherOrdersCompletedAdapter(Context ctx, List<Orders> ordersList){
        this.mCtx = ctx;
        this.ordersList = ordersList;
    }
    @Override
    public void onBindViewHolder(CarwasherOrdersCompletedAdapter.OrderViewHolder holder, int position) {
        Orders order = ordersList.get(position);
        holder.bindData(order);
    }

    @Override
    public CarwasherOrdersCompletedAdapter.OrderViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.orderscompleted_list_layout, parent,false);
        return new CarwasherOrdersCompletedAdapter.OrderViewHolder(view);
    }
